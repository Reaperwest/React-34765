const data = [
    ...
    {
      id: 4,
      title: "Sper Mario Oddysey",
      img: "https://images2.alphacoders.com/854/854342.png",
      price: 59,
      expired: true,
      detail: "EL ultimo mario",
      stock: 40,
      category: "nintendo-switch",
    },
    {
      id: 5,
      title: "Zelda Breth of the Wild",
      img: "https://www.muycomputer.com/wp-content/uploads/2021/03/Zelda.jpg",
      price: 69,
      expired: true,
      detail: "El zelda po",
      stock: 5,
    ...
    },
    {
      ...
      img: "https://cdn.akamai.steamstatic.com/steam/apps/1551360/capsule_616x353.jpg?t=1661275467",
      price: 43,
      expired: true,
      detail: "Forza horizon 5 detail",
      stock: 7,
      category: "xbox",
    },
    {
    ...
    },
    {
      ...
      img: "https://as01.epimg.net/meristation/imagenes/2022/08/20/noticias/1660984847_818491_1660985224_noticia_normal.jpg",
      price: 40,
      expired: true,
      detail: "Cyberpunk 2077 detail",
      stock: 15,
      category: "pc",
    }
  ];
  ...
  export function getGame(idParams) {
    return new Promise((resolve) => {
      let gameReq = data.find((item) => {
        return item.id === Number(idParams);
      });
      setTimeout(() => resolve(gameReq), 1000);
    });
  }
  
  export function getGamesByCategory(idCategoryParams) {
    return new Promise((resolve) => {
      let arrayFilterGames = data.filter(
        (item) => item.category === idCategoryParams
      );
      setTimeout(() => resolve(arrayFilterGames), 1000);
    });
  }